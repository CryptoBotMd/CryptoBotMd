...
let handler = async (_0x512ed3, {
  ...
  if (_0x197a8a !== "./src/avatar_contact.png") {
    ...
    _0x53e6f1 = await (await fetch("https://qu.ax/uvQcr.jpg")).buffer();
  }
  let _0x6bd16e = {
    'key': {
  ...
  let _0x238ca2 = global.db.data.nomedelbot || "𝐂𝐫ÿ𝐩𝐭øƁø𝐭-𝐌𝐝 ";
